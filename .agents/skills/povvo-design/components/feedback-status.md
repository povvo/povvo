...
Alerts, banners, toasts, dialogs, loading, empty, error, success, warning, recovery.
...
| --- | --- | --- | --- |
| feedback strip | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| empty field | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| modal board | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
...
Required terms covered: Alerts, Loading, Recovery. Related support files include behavioral states, perceptual patterns, semantic tokens, mode tokens, keyboard focus motion, and application rules.
