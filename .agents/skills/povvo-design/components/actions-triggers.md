...
Primary, secondary, tertiary, ghost, destructive, disabled, icon actions, links, and button groups.
...
| --- | --- | --- | --- |
| spec-button | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| icon trigger | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| action rail | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
...
Required terms covered: Buttons, Links, States. Related support files include behavioral states, perceptual patterns, semantic tokens, mode tokens, keyboard focus motion, and application rules.
