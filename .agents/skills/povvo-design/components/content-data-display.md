...
Spec panels, lists, tables, charts, badges, panels, widgets, thumbnails, and dense grids.
...
| --- | --- | --- | --- |
| spec panel | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| measured list | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| image plate | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
...
Required terms covered: Cards, Tables, Density. Related support files include behavioral states, perceptual patterns, semantic tokens, mode tokens, keyboard focus motion, and application rules.
