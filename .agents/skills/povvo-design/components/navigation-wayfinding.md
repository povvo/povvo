...
Headers, nav rails, tabs, menus, breadcrumbs, pagination, and platform navigation.
...
| --- | --- | --- | --- |
| ruler nav | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| section tabs | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| breadcrumb line | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
...
Required terms covered: Navigation, Wayfinding, Platform. Related support files include behavioral states, perceptual patterns, semantic tokens, mode tokens, keyboard focus motion, and application rules.
