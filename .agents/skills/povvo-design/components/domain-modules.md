...
Commerce, education, finance, service journeys, identity applications, and generated asset review modules.
...
| --- | --- | --- | --- |
| identity construction module | filled `POVVO`, outline `POVVO`, standalone `P`, guides | owns canonical identity display | spec sheet module |
| spec sheet module | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| asset review module | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
...
Required terms covered: Domain, Module, Constraint. Related support files include behavioral states, perceptual patterns, semantic tokens, mode tokens, keyboard focus motion, and application rules.
