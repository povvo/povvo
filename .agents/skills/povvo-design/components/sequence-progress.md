...
Step controls, ordered flows, scan progress, timers, completion, resume, retry, and exit.
...
| --- | --- | --- | --- |
| scan progress | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| step index | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
| product reveal | field, label, mark, state, optional action | owns one task or information cluster | feedback/status |
...
Required terms covered: Steps, Progress, Completion. Related support files include behavioral states, perceptual patterns, semantic tokens, mode tokens, keyboard focus motion, and application rules.
