...
| GIF bounded motion: repository-index.gif | PASS | median 0.56%, maximum 2.63% pixels changed |
...
| GIF size: event-rail.gif | PASS | 103.9 KiB |
...
| telemetry reel loop seam | PASS | maximum channel RMS 0.361 |
...
| black/off-white dominance: repository-signal.png | PASS | 92.42% |
