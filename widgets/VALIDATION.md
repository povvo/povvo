...
| GIF bounded motion: contribution-scan.gif | PASS | median 0.35%, maximum 0.47% pixels changed |
...
| aggregate GIF budget | PASS | 608.5 KiB across 6 animations |
...
| black/off-white dominance: repository-signal.png | PASS | 97.38% |
