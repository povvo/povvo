...
| GIF bounded motion: contribution-scan.gif | PASS | median 0.37%, maximum 0.57% pixels changed |
...
| GIF size: repository-signal.gif | PASS | 95.0 KiB |
...
| aggregate GIF budget | PASS | 634.5 KiB across 6 animations |
...
| black/off-white dominance: repository-signal.png | PASS | 92.28% |
