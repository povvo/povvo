...
| GIF bounded motion: contribution-scan.gif | PASS | median 0.36%, maximum 0.56% pixels changed |
...
| GIF bounded motion: repository-signal.gif | PASS | median 0.75%, maximum 2.16% pixels changed |
| GIF static-field stability: repository-signal.gif | PASS | unchanged calibration field |
| aggregate GIF budget | PASS | 636.0 KiB across 6 animations |
...
| telemetry reel size | PASS | 330.1 KiB |
...
| black/off-white dominance: repository-index.png | PASS | 93.90% |
...
| black/off-white dominance: repository-signal.png | PASS | 92.70% |
