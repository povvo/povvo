...
| GIF size: contribution-scan.gif | PASS | 92.4 KiB |
| GIF loop seam: contribution-scan.gif | PASS | maximum channel RMS 0.000 |
| GIF bounded motion: contribution-scan.gif | PASS | median 0.37%, maximum 0.70% pixels changed |
...
| GIF size: event-rail.gif | PASS | 99.6 KiB |
...
| telemetry reel loop seam | PASS | maximum channel RMS 0.347 |
| preview dimensions: contribution-scan.png | PASS | 900 x 220 |
| black/off-white dominance: contribution-scan.png | PASS | 88.34% |
...
| black/off-white dominance: event-rail.png | PASS | 95.64% |
