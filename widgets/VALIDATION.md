...
| GIF size: contribution-scan.gif | PASS | 91.1 KiB |
...
| GIF size: repository-signal.gif | PASS | 94.6 KiB |
| GIF loop seam: repository-signal.gif | PASS | maximum channel RMS 0.000 |
| GIF bounded motion: repository-signal.gif | PASS | median 0.76%, maximum 2.19% pixels changed |
| GIF static-field stability: repository-signal.gif | PASS | unchanged calibration field |
| aggregate GIF budget | PASS | 634.0 KiB across 6 animations |
...
| telemetry reel size | PASS | 328.4 KiB |
...
| black/off-white dominance: repository-signal.png | PASS | 92.29% |
