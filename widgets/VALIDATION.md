...
| GIF size: contribution-scan.gif | PASS | 91.7 KiB |
| GIF loop seam: contribution-scan.gif | PASS | maximum channel RMS 0.000 |
| GIF bounded motion: contribution-scan.gif | PASS | median 0.39%, maximum 0.53% pixels changed |
...
| GIF size: event-rail.gif | PASS | 101.8 KiB |
...
| GIF size: code-spectrum.gif | PASS | 95.9 KiB |
...
| aggregate GIF budget | PASS | 637.1 KiB across 6 animations |
...
| telemetry reel size | PASS | 329.3 KiB |
| telemetry reel loop seam | PASS | maximum channel RMS 0.367 |
| preview dimensions: contribution-scan.png | PASS | 900 x 220 |
| black/off-white dominance: contribution-scan.png | PASS | 88.65% |
