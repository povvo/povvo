...
| GIF size: contribution-scan.gif | PASS | 90.3 KiB |
...
| GIF size: event-rail.gif | PASS | 98.7 KiB |
| GIF loop seam: event-rail.gif | PASS | maximum channel RMS 0.000 |
| GIF bounded motion: event-rail.gif | PASS | median 0.58%, maximum 0.99% pixels changed |
...
| GIF size: code-spectrum.gif | PASS | 96.2 KiB |
| GIF loop seam: code-spectrum.gif | PASS | maximum channel RMS 0.000 |
| GIF bounded motion: code-spectrum.gif | PASS | median 0.59%, maximum 2.27% pixels changed |
...
| aggregate GIF budget | PASS | 624.4 KiB across 6 animations |
...
| telemetry reel size | PASS | 322.3 KiB |
| telemetry reel loop seam | PASS | maximum channel RMS 0.327 |
| preview dimensions: contribution-scan.png | PASS | 900 x 220 |
| black/off-white dominance: contribution-scan.png | PASS | 88.76% |
...
| black/off-white dominance: event-rail.png | PASS | 95.76% |
