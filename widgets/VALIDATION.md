...
| GIF bounded motion: contribution-scan.gif | PASS | median 0.36%, maximum 0.55% pixels changed |
...
| GIF size: repository-signal.gif | PASS | 95.7 KiB |
...
| telemetry reel size | PASS | 330.5 KiB |
...
| black/off-white dominance: repository-signal.png | PASS | 92.66% |
