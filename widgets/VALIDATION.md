...
| GIF bounded motion: repository-signal.gif | PASS | median 0.76%, maximum 2.16% pixels changed |
| GIF static-field stability: repository-signal.gif | PASS | unchanged calibration field |
| aggregate GIF budget | PASS | 638.9 KiB across 6 animations |
...
| black/off-white dominance: repository-signal.png | PASS | 92.57% |
