...
| GIF bounded motion: repository-index.gif | PASS | median 0.56%, maximum 2.62% pixels changed |
...
| aggregate GIF budget | PASS | 638.0 KiB across 6 animations |
...
| black/off-white dominance: event-rail.png | PASS | 95.31% |
...
| black/off-white dominance: repository-signal.png | PASS | 92.39% |
