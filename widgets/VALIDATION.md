...
| GIF bounded motion: contribution-scan.gif | PASS | median 0.37%, maximum 0.52% pixels changed |
...
| GIF size: repository-signal.gif | PASS | 94.2 KiB |
...
| aggregate GIF budget | PASS | 633.3 KiB across 6 animations |
...
| telemetry reel size | PASS | 329.2 KiB |
